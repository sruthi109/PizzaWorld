...
public class DeliveredAdapter extends BaseAdapter {
    ...
    Context context;
    public DeliveredAdapter(Context context, List<PojoDetails> pojoDetails){
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        com.example.pizzaworld.DeliveredAdapter.ViewHolder viewHolder;
        if(convertView==null)
        {
            convertView= LayoutInflater.from(parent.getContext()).inflate(R.layout.itemdelivered,null);
            viewHolder=new com.example.pizzaworld.DeliveredAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);
        }
        else {
            viewHolder=(com.example.pizzaworld.DeliveredAdapter.ViewHolder) convertView.getTag();
        ...
        viewHolder.user.setText("UserId-"+pojoDetails.getUserId());
    ...
    class ViewHolder{
        TextView name,price,quantity,des,user,address;
        ImageView imagepiz;
